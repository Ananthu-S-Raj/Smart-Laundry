        ...
        <div class="data-field">
            ...
            <div class="card-container">
                ...
                if (isset($_GET['id'])) {
                    ...
                    $query = "SELECT * FROM user_registration_table WHERE id = '$search_id'";
                } else {
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<div class="card">';
                        echo '<img class="card-img" src="media/user_card.jpeg" alt="Avatar">';
                        ...
                        echo '<p class="delete-btn" onclick="deleteUser(' . $row['id'] . ')">Delete User</p>';
                        echo '</div>';
                        echo '</div>';
                    }
                } else {
                    echo '<script>alert("No user found with that ID.");</script>';
...
deletewarning
        ...
        <p><b>Are you sure you want to delete this user ?</b><br>This action cannot be undone</p>

        <button class="yes-btn" onclick="deleteUserConfirmed()">Yes</button>
    ...
    <script>
        ...
        function deleteUserConfirmed() {
            ...
            var userId = window.deleteUserId;
