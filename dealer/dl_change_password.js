...
window.onload = function() {
    ...
    if (urlParams.get("message") === "dl_wrong_current_password") {
        alert("Wrong current Password!");
    }

    else if(urlParams.get("message") === "dl_password_change_successfull") {
            alert("Password changed successfully.!");
            window.location.href="dl_info.php"    
    }

    else if(urlParams.get("message") === "dl_same_passwords") {
